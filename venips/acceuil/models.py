...
class Clients (models.Model):
    ...
    profil = models.ImageField(upload_to='media/profil',default='img',error_messages={'non':'donnez une photo de profile'})
...
class freelances(models.Model):

    nomfree = models.ForeignKey(Clients, on_delete=models.CASCADE)
    qualite = models.CharField(max_length=200,verbose_name='comp')
    biographie = models.TextField()
    prix_jours = models.CharField(max_length=255)
    
class concepts_freelance(models.Model):
    ...
    designation = models.CharField( max_length=50,default='concepte')
